...
from util import upfirdn2d
from util import grid_sample_gradfix
...
class AugmentPipe(torch.nn.Module):
    ...
    def forward(self, images, debug_percentile=None):
        ...
        if self.imgfilter > 0:
            ...
            images = F.conv2d(images, Hz_prime.unsqueeze(2), groups=batch_size*num_channels)
            images = F.conv2d(images, Hz_prime.unsqueeze(3), groups=batch_size*num_channels)
